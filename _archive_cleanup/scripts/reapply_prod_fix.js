...
BEGIN
    ...
    -- 4. Delete tasks (references apiaries or assigned directly)
    DELETE FROM public.tasks WHERE apiary_id IN (
        SELECT id FROM public.apiaries WHERE user_id = target_user_id
    ) OR assigned_user_id = target_user_id;
    ...
    -- Assuming columns are mentor_id and student_id based on previous truncated output logic
    -- I will verify this quickly first.
